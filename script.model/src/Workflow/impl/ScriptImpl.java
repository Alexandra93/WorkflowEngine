 ...
 * </p>
 * <ul>
 *   <li>{@link Workflow.impl.ScriptImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link Workflow.impl.ScriptImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScriptImpl extends MinimalEObjectImpl.Container implements Script {
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<Command>(Command.class, this, WorkflowPackage.SCRIPT__COMMANDS);
		}
		return commands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WorkflowPackage.SCRIPT__COMMANDS:
