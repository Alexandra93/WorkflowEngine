...
public class CommandImpl extends MinimalEObjectImpl.Container implements Command {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.COMMAND__NAME, oldName, name));
	}
	...
	public EList<Option> getOptions() {
		if (options == null) {
			options = new EObjectContainmentEList<Option>(Option.class, this, WorkflowPackage.COMMAND__OPTIONS);
		}
		return options;
	}
